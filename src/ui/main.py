...
btn3 = ttk.Button(button_frame, text="Button 3", command=open_window3)
...
stats_header.grid(row=6, column=0, columnspan=2, sticky="w")
...
stats_label.grid(row=7, column=0, columnspan=2, sticky="ew")
